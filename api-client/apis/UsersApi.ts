...
import type { UserDTO, UsersResponseDTO } from '../models/index';
import {
  UserDTOFromJSON,
  UserDTOToJSON,
...
export class UsersApi extends runtime.BaseAPI {
  ...
  /**
   */
  async apiUsersCurrentUserIdGetRaw(
  ...
  /**
   */
  async apiUsersCurrentUserIdGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<string> {
    const response = await this.apiUsersCurrentUserIdGetRaw(initOverrides);
  ...
  async apiUsersGetRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UsersResponseDTO>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UsersResponseDTOFromJSON(jsonValue)
    );
  }
